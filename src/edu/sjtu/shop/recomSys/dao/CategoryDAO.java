 ...
 * 
 * @see edu.sjtu.shop.recomSys.pojo.Category
...
public class CategoryDAO extends BaseHibernateDAO {
	...
	public static final String PLUARL_NAME = "pluarlName";
	...
	public Category findById(java.lang.String id) {
		...
		try {
			Category instance = (Category) getSession().get(
					"edu.sjtu.shop.recomSys.pojo.Category", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Category instance) {
		...
		try {
			List results = getSession()
					.createCriteria("edu.sjtu.shop.recomSys.pojo.Category")
	...
	public List findByPluarlName(Object pluarlName) {
		return findByProperty(PLUARL_NAME, pluarlName);
	}
